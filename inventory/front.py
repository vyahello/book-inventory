...
"""
from tkinter import *
from inventory.back import Database
...
class LibraryGUI:
    def __init__(self, window):
        ...
        # Buttons
        b1 = Button(
            self.window, text="View All", width=12, command=self.refresh_list
        )
        ...
        b3 = Button(
            self.window, text="Add Entry", width=12, command=self.add_command
        )
        ...
        b6 = Button(
            self.window, text="Close", width=12, command=self.window.destroy
        )
